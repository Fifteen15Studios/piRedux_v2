...
public class MainActivity extends Activity
{
	...
	int identification_counter = 0, identification_ender = 0;
	int setFinalWidth = 0, setFinalHeight = 0;
	int setSampleScale = 0;
	int setDesiredWidth = 0;
	int setDesiredHeight = 0;
	int imageRotation = 0, finalRotation = 0;
